...
const ChatWindow = ({ appointment, onClose, onStartCall }) => {
    ...
    useEffect(() => {
        ...
        if (appointmentId && token) fetchMessages()
    ...
    useEffect(() => {
        ...
        const join = () => {
            console.log('[Chat] Joining room:', appointmentId)
        ...
        const handleTyping = ({ senderType }) => {
            if (senderType === 'doctor') setIsTyping(true)
        }

        const handleStopTyping = ({ senderType }) => {
            if (senderType === 'doctor') setIsTyping(false)
        }
    ...
    const handleSend = useCallback(() => {
        ...
        setNewMessage('')
        inputRef.current?.focus()
    }, [newMessage, socket, appointmentId, userData])
    ...
    const handleFileSelected = async (e) => {
        ...
        try {
            ...
            if (data.success) {
                // The server broadcasts the message via socket; nothing extra needed here
            ...
            <div className="chat-container">
                ...
                <div className="chat-header">
                    ...
                    <div className="chat-header-actions">
                        {/* Audio Call Button — wired to handleAudioCall */}
                        <button
                        ...
                        {/* Video Call Button — wired to handleVideoCall */}
                        <button
                            className="chat-header-btn"
                    ...
                    <div className="chat-messages">
                        {messages.map((msg, index) => (
                            <React.Fragment key={msg._id || index}>
                                ...
                                <div className={`chat-message ${msg.senderType === 'user' ? 'sent' : 'received'}`}>
                ...
                <div className="chat-input-area">
                    ...
                    />
                    {/* Attach button — wired to handleAttachClick */}
                    <button
